 ...
 * 创建时间： 2018/4/17 0017
 */
public class XiwiImageView extends AppCompatImageView {
    private float width;
    ...
    public XiwiImageView ( Context context ) {
        this(context, null);
    }

    public XiwiImageView ( Context context, @Nullable AttributeSet attrs ) {
        this(context, attrs, 0);
    }

    public XiwiImageView ( Context context, @Nullable AttributeSet attrs, int defStyleAttr ) {
